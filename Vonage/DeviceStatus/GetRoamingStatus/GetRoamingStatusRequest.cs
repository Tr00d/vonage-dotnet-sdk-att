...
/// <inheritdoc />
public readonly struct GetRoamingStatusRequest : IVonageRequest
{
    /// <summary>
    ...
    private static string Scope => "dpv:NotApplicable#device-status:roaming:read";
    ...
    /// <inheritdoc />
    public string GetEndpointPath() => "camara/device-status/v050/roaming";
    ...
    public static IBuilderForPhoneNumber Build() => new GetRoamingStatusRequestBuilder();
}